...
async def auto_filter(bot: Client, update: Message):
    ...
    if filters:
        results.append(
                [
                    InlineKeyboardButton("💢 𝗝𝗼𝗶𝗻 𝗢𝘂𝗿 𝗠𝗮𝗶𝗻 𝗰𝗵𝗮𝗻𝗻𝗲𝗹 💢", url=f"https://t.me/joinchat/nAJOyC9EPe5kMTBl")
                ]
            )
    ...
    if len(results) == 0: # double check
        ...
        try:
            await bot.send_photo(
                ...
                photo= "https://telegra.ph/file/4e294b68bbe7f0eb130ff.jpg",
                text=f"<b>🌩 𝐓𝐨𝐭𝐚𝐥 𝐑𝐞𝐬𝐮𝐥𝐭𝐬: {(len_results)} </b>\n<b>🎬 𝐌𝐨𝐯𝐢𝐞/𝐒𝐞𝐫𝐢𝐞𝐬:</b> <code>{query}</code>",
